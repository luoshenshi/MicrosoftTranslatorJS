"use strict";Object.defineProperty(exports, "__esModule", {value: true}); function _nullishCoalesce(lhs, rhsFn) { if (lhs != null) { return lhs; } else { return rhsFn(); } } function _optionalChain(ops) { let lastAccessLHS = undefined; let value = ops[0]; let i = 1; while (i < ops.length) { const op = ops[i]; const fn = ops[i + 1]; i += 2; if ((op === 'optionalAccess' || op === 'optionalCall') && value == null) { return undefined; } if (op === 'access' || op === 'optionalAccess') { lastAccessLHS = value; value = fn(value); } else if (op === 'call' || op === 'optionalCall') { value = fn((...args) => value.call(lastAccessLHS, ...args)); lastAccessLHS = undefined; } } return value; }// src/Network/NetworkClient.ts
...
var _Translator = class _Translator {
  ...
  async translate(text, from, to) {
    ...
    try {
      ...
      return _nullishCoalesce(_optionalChain([match, 'optionalAccess', _ => _[1]]), () => ( "Not Found"));
    } catch (error) {
      if (_optionalChain([error, 'access', _2 => _2.message, 'optionalAccess', _3 => _3.includes, 'call', _4 => _4("getaddrinfo ENOTFOUND")])) {
  ...
  clientTraceId() {
    return _crypto.randomUUID.call(void 0, ).replace(/[:\[\]<>]/g, "");
  }
  generateSignature(url) {
    let formattedUrl = url.replace(/^https?:\/\//i, "").toLowerCase();
    const encodedUrl = encodeURIComponent(formattedUrl);
    const timestamp = this.getTimestamp();
    const uniqueId = _crypto.randomUUID.call(void 0, ).replace(/-/g, "");
    ...
    try {
      ...
      const hmac = _crypto.createHmac.call(void 0, "sha256", key).update(data).digest("base64");
...
exports.Translator = Translator; exports.TranslatorLocale = TranslatorLocale;
